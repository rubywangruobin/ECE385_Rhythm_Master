...
# SDRAM CLK
create_generated_clock -source [get_nets { m_lab8_soc|altpll_0|sd1|wire_pll7_clk[1] }] \
...
set_multicycle_path -from [get_clocks {clk_dram_ext}] \
                    -to [get_clocks { m_lab8_soc|altpll_0|sd1|pll7|clk[0] }] \
						  -setup 2
...
# Set False Path
#**************************************************************
set_false_path -from [get_ports {KEY* SW* altera_*}]
set_false_path -to [get_ports {LED* altera_*}]
